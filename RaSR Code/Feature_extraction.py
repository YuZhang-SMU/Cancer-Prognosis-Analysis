...
data_path = 'D:/KIRC_Data/KIRC_his/KIRC_his_all' # File location of path after unified magnification and histogram matching
...
import pandas as pd
output = pd.DataFrame(feature_matrix)
output.to_csv('D:/KIRC_Data/KIRC_his/KIRC_pftas.csv') # File to save pftas features
name = pd.DataFrame(patient_list2)
name.to_csv('D:/KIRC_Data/KIRC_his/KIRC_Pftas_name.csv') # File to Save the patient number corresponding to the pftas features file
time_end=time.time()
